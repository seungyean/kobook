...
<script type="text/javascript">
	function update() {
		location.href = "/Testtt/admin/updateNoti.do?board_id=${board.board_id}";
	}
	function list_fn() {
		location.href = "/Testtt/admin/noti.do?board_id=${board.board_id}";
	}
	function remove_fn() {
		location.href = "/Testtt/admin/deleteNoti.do?board_id=${board.board_id}";
	}
</script>
	<!--Start Header-->
	<header id="header">
	...
	<section class="content faq">
		<div class="container">
			...
			<table border="1" cellpadding="0" cellspacing="0" >
				<tr height="50">
					<td align="left" width="300">글제목 : ${board.board_title } </td>
					<td width="500" align="right">날짜 : ${board.board_date }</td>
				</tr>
				<tr height="50">
					<td align="left" width="300">작성자 : ${board.board_writer }</td>
					<td align="right" width="650">조회수 : ${board.board_hit }</td>
				</tr>
				<tr height="300">
					<td colspan="2" align="left">
					글내용  : ${board.board_content }</td>
				</tr>
			</table>
