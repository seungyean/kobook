				...
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						<div class="blog_single">
							<article class="post">
								<form action="blackUpdateAction.do" method="post"
									...
									<div class="post_content">
										<div class="post_meta">
											<input type="text" name="black_title"
												value="${black.black_title }">
											<div class="metaInfo">
												<span><i class="fa fa-calendar"></i> <fmt:formatDate
														value="${black.black_date }" pattern="MMM dd, yyyy" />
										...
										<input type="hidden" name="black_img"
											value="${black.black_img }"> <input type="file"
											name="blackUimg">
									</div>
